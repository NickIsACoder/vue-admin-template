<template>
  <div class="app-container">
      ...
      <el-form ref="postForm" :model="postForm" class="form-container">
        <el-row type="flex" :gutter="20" justify="start">
          <el-col :span="24">
            ...
            <el-button type="warning" icon="el-icon-s-check" class="fr" @click="reset">一键审核</el-button>
            <el-button type="warning" icon="el-icon-edit" class="fr" @click="reset">短信</el-button>
            <el-button type="warning" icon="el-icon-upload" class="fr" @click="reset">导出</el-button>
          </el-col>
        </el-row>
      </el-form>
    </div>
    <el-table
      ...
      tooltip-effect="dark"
      @selection-change="selectArrChange"
    ...
    >
      ...
      >
        <template slot-scope="scope">
          <el-button type="primary" size="mini" @click.stop="goDetail(scope.row)">详情</el-button>
          <el-button type="primary" size="mini" @click.stop="modifyHandle(scope.row)">修改</el-button>
